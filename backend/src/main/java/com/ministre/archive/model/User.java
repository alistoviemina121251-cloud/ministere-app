...
public class User {
    ...
    @Column(name = "nom_utilisateur", nullable = false, unique = true) private String nomUtilisateur;
    @Column(nullable = false, unique = true) private String email;
    @Column(nullable = false) private String password;
    @Column(name = "date_inscription") private LocalDateTime dateInscription;
    @Column(name = "derniere_connexion") private LocalDateTime derniereConnexion;
    @Column(name = "code_confirmation") private String codeConfirmation;
    @Column(name = "code_expiration") private LocalDateTime codeExpiration;
    @Column(name = "actif") private Boolean actif = false;
    private String role;
